...
if __name__ == '__main__':
    print(f"MD5={my_md5('wj123456')}")
    print(f"SHA1={my_sha1('wj123456')}")
    print(f"SHA256={my_sha256('wj123456')}")
    print(f"DES={my_des('wj123456', '88888888')}")
    print(f"aes_encrypt={my_aes_encrypt('EzF4nbseQmgtvXnD', 'abcdefghjklmnopu', 'abcdefghjklmnopq')}")
    print(f"aes_decrypt={my_aes_decrypt('0d2b028ee430e6bca89e2c661d035f7d', 'abcdefghjklmnopu', 'abcdefghjklmnopq')}")